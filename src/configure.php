...
use Fi1a\Validation\Rule\BetweenDateRule;
...
use Fi1a\Validation\Rule\EqualDateRule;
use Fi1a\Validation\Rule\EqualRule;
use Fi1a\Validation\Rule\FileSizeRule;
use Fi1a\Validation\Rule\GenericRule;
...
use Fi1a\Validation\Rule\MaxDateRule;
...
use Fi1a\Validation\Rule\MinDateRule;
...
Validator::addRule(EqualRule::class);
Validator::addRule(MinDateRule::class);
...
Validator::addRule(GenericRule::class);
